    ...
    <div class="home-post-tabs">
        ...
        <div v-if="isActiveStatus === false" class="latest-post px-1 h-[430px] overflow-y-auto mt-2">
            <NuxtLink
                ...
                <h4 class="text-[20px] group-hover:text-[#ff0000] text-[#121212] leading-6"> {{ latstpost?.content_heading
                }}</h4>
        ...
        <div v-else class="latest-post px-1 h-[430px] overflow-y-auto mt-2">
            <NuxtLink
                ...
                <h4 class="text-[20px] group-hover:text-[#ff0000] text-[#121212] leading-6"> {{ poplarpost?.content_heading
                }}</h4>
            </NuxtLink>
