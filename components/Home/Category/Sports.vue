<template>
    <div class="home-sports-category">
        <div class="category-header border-b-4 border-b-[#3375af] my-3">
            <NuxtLink :to="`/${sportscontent[0]?.category?.cat_slug}`" class="flex gap-3 items-center">
        ...
        <div class="grid grid-cols-12 gap-4">
            <div class="col-span-12 md:col-span-7">
                <NuxtLink :to="`/category/${sportscontent[0]?.category?.cat_slug}/${sportscontent[0]?.content_id}`"
...
const { data: hsport } = await useFetch('/api/home/sportscontent', {
    method: 'GET'
})
