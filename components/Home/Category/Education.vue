<template>
    <div class="home-education-category " v-if="educationcontents?.length > 0">
        ...
        <div class="home-int-c-content flex flex-col gap-3">
            ...
            <NuxtLink :to="`/category/${educationcontents[0]?.cat_slug}/${educationcontents[0]?.content_id}`" class="flex flex-col gap-2 group">
            ...
            <div class="h-p-c-excpt flex flex-col">
                <!-- Loop Item -->
                <NuxtLink :to="`/category/${educationcontent?.cat_slug}/${educationcontent?.content_id}`" class=" border-b py-3" v-for="educationcontent in educationcontents.slice(1,5)"
